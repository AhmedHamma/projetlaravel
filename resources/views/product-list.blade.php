    ...
    <div class="list-product">
                    ...
                    @foreach($categories as $category)
                        @if($category->products)
                            ...
                            @foreach($category->products as $prod)
                                <p>{{$prod->name}}</p>
                                <p><img height="180" src="{{$prod->picture}}" alt="image qui ne marche pas">
                                    pour {{$prod->price}} €</p>
                            @endforeach
                        @endif
                    @endforeach
        ...
        <div class="item">
            <div class="flex-zone">
                ...
                <div class="item-container">
                    <h2>Lorem Ipsum</h2>
                    <p>Lorem ipsum dolor sit amet, consghtgdhdghhgectetur adipiscing elit, sed do eiusmod tempor
                        incididunt ut
                        labore et dolore magna
                        aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                        commodo consequat. Duis
